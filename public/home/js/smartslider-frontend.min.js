(function () {
    ...
    return e.prototype.loadWithProgress = function (t) {
        ...
        var r, o = a.Deferred();
        return "resolved" !== e[0].state() ? (r = setTimeout(function () {
            this.slider.load.showSpinner("backgroundImage" + t[0].index), r = null
        }.bind(this), 50), a.when.apply(a, e).done(function () {
    ...
    return e.prototype.start = function () {
        var i;
        this.parameters.scroll ? (this.onScrollCallback = this.onScroll.bind(this), window.addEventListener("scroll", this.onScrollCallback, {
            capture: !0,
            passive: !0
        }), this.onScroll()) : (this.parameters.fade && (this.loadingArea = this.$placeholder, this.showSpinner("fadePlaceholder"), (i = this.spinner.find(".n2-ss-spinner-counter")).length && (i.html("0%"), this.slider.stages.done("SlidesReady", function () {
        ...
        this.slider.responsive.doResize(), this.slider.stages.resolve("BeforeShow"), this.slider.widgets.onReady(), this.slider.responsive.alignElement.addClass("n2-ss-align-visible"), this.slider.sliderElement.addClass("n2-ss-loaded").removeClass("n2notransition"), this.spinner.find(".n2-ss-spinner-counter").html(""), this.removeSpinner("fadePlaceholder"), this.$placeholder.remove(), this.loadingArea = this.slider.sliderElement, i(window).scroll(), this.slider.stages.resolve("Show"), this.slider.startVisibilityCheck()
    ...
    return {
        addPlugin: function (t, e) {
            for (var i = 0; i < r.length; i++) r[i].plugins.add(t, e);
            n[t] = e
        },
    ...
    return s.prototype.add = function (t, e, i, s) {
        ...
        this.items.push(s), this._onScroll(s, Math.max(document.documentElement.clientHeight, window.innerHeight)), this.started || this.start()
...
}), N2D("SmartSliderApi", function (a, s) {
    function t() {
        this.sliders = {}, this.readys = {}, this.eventListeners = {}
    }
    t.prototype.makeReady = function (t, e) {
        if (this.sliders[t] = e, this.readys[t] !== s)
            for (var i = 0; i < this.readys[t].length; i++) this.readys[t][i].call(e, e, e.sliderElement)
    }, t.prototype.ready = function (t, e) {
        this.sliders[t] !== s ? e.call(this.sliders[t], this.sliders[t], this.sliders[t].sliderElement) : (this.readys[t] === s && (this.readys[t] = []), this.readys[t].push(e))
    }, t.prototype.on = function (t, e) {
        this.eventListeners[t] === s && (this.eventListeners[t] = []), this.eventListeners[t].push(e)
    }, t.prototype.off = function (t, e) {
        if (this.eventListeners[t] !== s)
        ...
        if (this.eventListeners[t] !== s && this.eventListeners[t].length)
        ...
        var i = a(t),
            s = e.split(","),
            t = i.closest(".n2-ss-slide,.n2-ss-static-slide"),
            n = t.data("ss-last-event");
        i.data("ss-reset-events") || (i.data("ss-reset-events", 1), t.on("layerAnimationPlayIn.resetCounter", function (t) {
            t.data("ss-last-event", "")
        }.bind(this, t)));
        for (var r = s.length - 1, o = 0; o < s.length; o++) s[o] === n && (r = o);
        e = r === s.length - 1 ? s[0] : s[r + 1], t.data("ss-last-event", e), t.triggerHandler("ss" + e)
    }, t.prototype.applyAction = function (t, e) {
        var i;
        this.isClickAllowed(t) && (i = t.currentTarget, (i = a(i).closest(".n2-ss-slider").data("ss"))[e].apply(i, Array.prototype.slice.call(arguments, 2)))
        ...
        return !a.contains(t.currentTarget, a(t.target).closest('a[href!="#"], *[onclick][onclick!=""], *[data-n2click][data-n2click!=""], *[data-n2-lightbox]').get(0))
    }, t.prototype.openUrl = function (t, e) {
        var i;
        this.isClickAllowed(t) && (t = (i = a(t.currentTarget)).data("href"), e === s && (e = i.data("target")), "_blank" === e ? ((e = window.open()).opener = null, e.location = t) : n2const.setLocation(t))
    };
    var n = {
        focusOffsetTop: 0,
        to: function (t) {
            var e = a("html, body, .n2_iframe_application__content");
            "smooth" === a("html").css("scroll-behavior") ? e.scrollTop(t) : e.animate({
                scrollTop: t
        ...
        bottom: function () {
            n.to(a(document).height() - a(window).height())
        },
        before: function (t) {
            n.to(t.offset().top - a(window).height())
        },
        after: function (t) {
        ...
        next: function (i, t) {
            var t = a(t),
                s = -1;
            t.each(function (t, e) {
                if (a(i).is(e) || a.contains(e, i)) return s = t + 1, !1
            }), -1 !== s && s <= t.length && n.element(t.eq(s))
        },
        previous: function (i, t) {
            ...
            t.each(function (t, e) {
                if (a(i).is(e) || a.contains(e, i)) return s = t - 1, !1
            }), 0 <= s && n.element(t.eq(s))
        },
        element: function (t) {
            n.to(a(t).offset().top - n.focusOffsetTop)
        }
    };
    return t.prototype.scroll = function (t, e) {
        var i;
        this.isClickAllowed(t) && (t.preventDefault(), (i = this.findSliderByElement(t.target)) && (n.focusOffsetTop = i.responsive.focusOffsetTop), n[e].apply(window, Array.prototype.slice.call(arguments, 2)))
    }, t.prototype.findSliderByElement = function (t) {
        return a(t).closest(".n2-ss-slider").data("ss")
    ...
    SmartSliderAbstract.prototype.kill = function () {
        ...
        t = this.sliderElement.closest(".n2-ss-margin");
        t.length ? t.remove() : N2R("documentReady", function (t) {
            this.sliderElement.closest(".n2-ss-margin").remove()
        }.bind(this));
        t = this.sliderElement.closest(".n2-ss-align");
        t.length ? t.remove() : N2R("documentReady", function (t) {
    ...
    function lazySliderCheckScroll() {
        for (var t, e = 1.4 * $(window).height(), i = 0; i < lazySliders.length; i++) lazySliders[i].element.getBoundingClientRect().y < e && (t = lazySliders[i].callback, lazySliders.splice(i, 1), i--, t());
    ...
    return SmartSliderAbstract.prototype.onSliderExists = function (t, e, i) {
        var s, n;
        this.__$sliderElement = i, this.stages.resolve("Exists"), "TEMPLATE" === i.prop("tagName") ? (s = i.data("loading-type"), n = function () {
            var t = $(i.html());
            i.replaceWith(t), this.waitForDimension(t, e), $(window).triggerHandler("n2Rocket", [t])
        }.bind(this), "afterOnLoad" === s ? N2R("windowLoad", lazySliderLoad.bind(this, this, n)) : "afterDelay" === s ? setTimeout(n, i.data("loading-delay")) : n()) : this.waitForDimension(i, e)
        ...
        if (this.sliderElement.on({
            ...
            }), this.parameters.carousel || this.initNotCarousel(), this.initHideArrow(), this.controls = {}, this.parameters.blockrightclick && this.sliderElement.bind("contextmenu", function (t) {
                t.preventDefault()
            ...
            this.initControls(), this.stages.resolve("UIReady"), this.isAdmin || (eventName = "click", this.hasTouch() && (eventName = "n2click"), this.sliderElement.find("[data-n2click]").each(function (i, el) {
                var el = $(el);
            ...
            })), this.load.start(), this.sliderElement.keypress(function (t) {
                32 !== t.charCode && 13 !== t.charCode || ($target = $(t.target).filter('[role="button"],[tabindex]').not("a,input,select,textarea"), $target.length && (t.preventDefault(), $(t.target).click().triggerHandler("n2Activate")))
        ...
        var t = this.parameters.playWhenVisibleAt,
            ...
            o = e + r,
            t = e + i - r;
        e < r && (o *= e / r), s - r < e + i && (t += e + i - s + r);
        r = e + n.top, n = e + n.bottom;
        (this.isAdmin || r <= t && o <= r || o <= n && n <= t || r <= o && t <= n) && this._markVisible()
        ...
        if (this.responsive.parameters.focusUser && !t && (e = !0), e) {
            var i = $(window).scrollTop(),
                ...
                a = o.top - s,
                l = r - o.bottom - n,
                t = this.responsive.parameters.focusEdge,
                e = "";
            "top-force" === t ? e = "top" : "bottom-force" === t ? e = "bottom" : a <= 0 && l <= 0 || 0 < a && 0 < l || (a < 0 ? e = "top" === t || "bottom" !== t && -a <= l ? "top" : "bottom" : l < 0 && (e = "top" !== t && ("bottom" === t || -l <= a) ? "bottom" : "top"));
            a = i;
            if ("top" === e ? a = i - s + o.top : "bottom" === e && (a = i + n + o.bottom - r), a !== i) return this._scrollTo(a, Math.abs(i - a))
        }
        return !0
        ...
        var e, i = !1;
        return "next" === t ? (e = this.currentSlide.getNext()) && (i = e.index) : "previous" !== t || (t = this.currentSlide.getPrevious()) && (i = t.index), !1 !== i && i !== this.currentSlide.index
    ...
    }, SmartSliderAbstract.prototype.changeTo = function (i, s, n, r) {
        ...
        return $.when($.when.apply($, this.backgrounds.preLoadSlides(this.getVisibleSlides(this.slides[i]))), this.focus(n)).done(function () {
            ...
            i !== this.currentSlide.index && this.mainAnimationLastChangeTime <= o && (this.mainAnimationLastChangeTime = o, "ended" === (t = this.mainAnimation.getState()) ? (n === undefined && (n = !1), e = this.mainAnimation, r !== undefined && (e = r), this._changeTo(i, s, n, r), e.changeTo(this.currentSlide, this.slides[i], s, n), this._changeCurrentSlide(i)) : "initAnimation" !== t && "playing" !== t || (this.sliderElement.off(".fastChange").one("mainAnimationComplete.fastChange", function () {
                this.changeTo.call(this, i, s, n, r)
        ...
        }, 400), n.data("ss").slideToID(t, e, !0)) : void 0)
        ...
        this.isVisible || (this.responsive.alignElement.removeClass("n2-ss-slider-has-no-slide"), this.load.$placeholder.removeClass("n2-ss-slider-has-no-slide"), $(window).scroll(), this.isVisible = !0)
...
}), N2D("Stages", function (r, e) {
    function t() {
        this.stages = {}
    }

    function i(t) {
        this.n = t, this.d = r.Deferred()
    }
    ...
    return SmartSliderWidgets.prototype.register = function (t, e) {
        ...
        var e, i;
        this.controls[t] && (e = !0, this.controls[t].$widget.hasClass("n2-ss-widget-display-hover") && (e = this.states.hover), e && (t === this.slider.getDirectionPrevious() && this.states.nonCarouselFirst || t === this.slider.getDirectionNext() && this.states.nonCarouselLast) && (e = !1), e && (i = t + "-" + (this.states.currentSlideIndex + 1), this.excludedSlides[i] && (e = !1)), e && this.states["hide." + t] !== undefined && this.states["hide." + t] && (e = !1), e && this.states.singleSlide && ("previous" !== t && "next" !== t && "bullet" !== t && "autoplay" !== t && "indicator" !== t || (e = !1)), this.controls[t].$widget.toggleClass("n2-ss-widget-hidden", !e))
        ...
        var t, e, i = !1;
        for (t in this.controls)
            if (this.controls[t] !== undefined) {
                var s = this.controls[t].$widget.attr("data-exclude-slides");
                if (s !== undefined) {
                    for (var n = s.split(","), r = n.length - 1; 0 <= r; r--) {
                        var o = n[r].split("-");
                        if (2 === o.length) {
                            var a = parseInt(o[0]),
                                l = parseInt(o[1]);
                            if (a <= l)
                                for (var h = a; h <= l; h++) n.push(h)
                        } else n[r] = parseInt(n[r])
                    }
                    if (0 < n.length) {
                        for (r = 0; r < n.length; r++) this.excludedSlides[t + "-" + n[r]] = !0;
                        i = !0
                    }
                }
            } i && ((e = function (t, e) {
            this.setState("currentSlideIndex", e.index)
        }.bind(this))(null, this.slider.currentRealSlide), this.slider.sliderElement.on("SlideWillChange", e)), this.variableElements = {
        ...
        var temp, dimensions = this.getDimensions(),
            k, k;
        for (k in this.dimensions = dimensions, this.controls) this.controls[k] !== undefined && this.controls[k].filterSliderVerticalCSS(cssData);
        for (k in eval(this.dimensionsToVariables(dimensions)), this.variableElements)
            for (var i = 0; i < this.variableElements[k].length; i++) {
                var el = this.variableElements[k].eq(i);
                try {
                    var value = eval(el.data("ss" + k)),
                        temp = {};
                    temp[k] = value + "px", cssData.push(new N2Classes.CSSData(el, temp))
                } catch (e) {
...
}), N2D("SmartSliderMainAnimationAbstract", function (i, t) {
    function s(t, e) {
        this.state = "ended", this.isTouch = !1, this.isReverseAllowed = !0, this.isReverseEnabled = !1, this.reverseSlideIndex = null, this.isNoAnimation = !1, this.slider = t, this.parameters = i.extend({
            duration: 1500,
            ease: "easeInOutQuint"
    ...
    return s.prototype.init = function () {
        ...
        var s = t.totalDuration(),
            e = Math.max(s / 3, Math.min(s, i / Math.abs(e) / 1e3));
        e !== s && t.totalDuration(e)
        ...
        this.state = "playing";
        i = [this, t.index, e.index, i];
        this.slider.trigger("mainAnimationStart", i), t.triggerHandler("mainAnimationStartOut", i), e.triggerHandler("mainAnimationStartIn", i)
    ...
    return t.prototype.getAnchor = function () {
        ...
        return e && (e === this.parameters.alias || this.parameters.slideSwitch && -1 < e.indexOf(this.parameters.alias) ? t.hasAnchor = 1 : this.parameters.href = this.parameters.href.replace("#" + e, ""), -1 < e.indexOf("-") && (e = e.split("-"), t.number = e[e.length - 1])), t
    }, t.prototype.switchOnLoad = function () {
        var t;
        this.createAnchorElements(), this.parameters.anchor.hasAnchor && ((t = this.parameters.anchor.number) === e && this.parameters.slideSwitch && (t = this.getParameterNumber()), null !== t && (t--, window["ss" + this.parameters.slider.id] = t, N2R("windowLoad", function (t) {
        ...
        this.parameters.scroll && this.parameters.smoothScroll && s("html, body").animate({
    ...
    return t.prototype.preventClickHandle = function () {
        ...
        var s;
        (e || i) && (s = !1, this.slider.sliderElement.on({
        ...
        var e = this.slider.realSlides[this.slider.getRealIndex(t)],
            t = e.minimumSlideDuration;
        return 0 === parseInt(e.minimumSlideDuration) && (t = this.parameters.duration), t
    }, t
}), N2D("SmartSliderControlFullscreen", function (s, t) {
    "use strict";
    ...
    function e(t, e, i) {
        ...
        t.requestFullscreen ? (this.browserSpecific.requestFullscreen = "requestFullscreen", this.browserSpecific.event = "fullscreenchange") : t.msRequestFullscreen ? (this.browserSpecific.requestFullscreen = "msRequestFullscreen", this.browserSpecific.event = "MSFullscreenChange") : t.mozRequestFullScreen ? (this.browserSpecific.requestFullscreen = "mozRequestFullScreen", this.browserSpecific.event = "mozfullscreenchange") : t.webkitRequestFullscreen ? (this.browserSpecific.requestFullscreen = "webkitRequestFullscreen", this.browserSpecific.event = "webkitfullscreenchange") : (this.browserSpecific.requestFullscreen = "nextendRequestFullscreen", this.browserSpecific.event = "nextendfullscreenchange", this.fullParent[0][this.browserSpecific.requestFullscreen] = function () {
            this.fullParent.css({
                ...
                backgroundColor: "#000",
                zIndex: 1e6
            }), document.fullscreenElement = this.fullParent[0], this.triggerEvent(document, this.browserSpecific.event), s(window).trigger("resize")
    ...
    return e.prototype.switchState = function () {
        ...
        this.forceFullpage && (this.responsive.isFullScreen = !0, this.responsive.parameters.type = "fullpage", this.responsive.parameters.upscale = !0, this.responsive.parameters.forceFull = !1, this._marginLeft = this.responsive.containerElement[0].style.marginLeft, this.responsive.containerElement.css(n2const.rtl.marginLeft, 0)), this.fullParent.css({
            width: "100%",
            height: "100%",
            backgroundColor: s("body").css("background-color")
        ...
        this.isDocumentInFullScreenMode() ? (this.slider.trigger("n2FullScreen"), s("html").addClass("n2-in-fullscreen"), this.isFullScreen = !0, s(window).trigger("resize")) : this.forceFullpage && (this.responsive.isFullScreen = !1, this.responsive.parameters.type = this._type, this.responsive.parameters.upscale = this._upscale, this.responsive.parameters.forceFull = this._forceFull, this.responsive.containerElement.css(n2const.rtl.marginLeft, this._marginLeft), this.fullParent.css({
            width: "",
            height: "",
            backgroundColor: ""
        }).removeClass("n2-ss-in-fullscreen"), s("html").removeClass("n2-in-fullscreen"), s(window).trigger("resize"), this.isFullScreen = !1, this.slider.trigger("n2ExitFullScreen"))
    ...
    function o(t, e, i) {
        this.slider = t, this.parameters = s.extend({}, i), this.parseEvent = "vertical" === e ? o.prototype.parseEventVertical : o.prototype.parseEventHorizontal, (n = n || new r).addControl(this), this.slider.sliderElement.on("SliderKeyDown", this.onKeyDown.bind(this)), t.controls.keyboard = this
    }
    return r.prototype.onMouseMove = function (t) {
        this.mouseEvent = t
        ...
        if (t.target.tagName.match(/BODY|DIV|IMG/) && !t.target.isContentEditable)
            if (this.mouseEvent && (e = this.findSlider(document.elementFromPoint(this.mouseEvent.clientX, this.mouseEvent.clientY)))) e.trigger("SliderKeyDown", t);
            else if (document.activeElement !== document.body && (e = this.findSlider(document.activeElement))) e.trigger("SliderKeyDown", t);
        else
            for (var i = 0; i < this.controls.length; i++) this.controls[i].onKeyDown(!1, t)
    }, r.prototype.findSlider = function (t) {
        var t = s(t),
            t = t.hasClass("n2-ss-slider") ? t : t.closest(".n2-ss-slider");
        return !!t.length && t
    ...
    }, o.prototype.parseEventVertical = function (t) {
        switch (t.keyCode) {
            case 40:
    ...
    return e.prototype.hasScrollableParentRecursive = function (t, e) {
        ...
        this.preventScroll.curveGlobal && (this.dynamicDelta || this.lastDeltaY === t.deltaY || (this.lastDeltaY = t.deltaY, this.dynamicDelta = !0), t = Math.abs(t.deltaY), this.preventScroll.curve && this.maxDelta / 2 > t && this.releaseCurveLock(), this.maxDelta = Math.max(this.maxDelta, t), this.preventScroll.curveGlobalTimeout && clearTimeout(this.preventScroll.curveGlobalTimeout), this.preventScroll.curveGlobalTimeout = setTimeout(s.proxy(function () {
            this.preventScroll.curveGlobal = !1, this.maxDelta = 0
        }, this), 500))
    ...
    return i.prototype.onStarterSlide = function () {
        -1 < navigator.userAgent.toLowerCase().indexOf("android") && "1" !== this.swipeElement.parent().css("opacity") ? this.swipeElement.parent().one("transitionend", this.initTouch.bind(this)) : this.initTouch(), this.slider.sliderElement.on("sliderChangeCurrentSlide", this.updatePanDirections.bind(this))
        ...
        "switch" === this.currentInteraction.action && (s = s ? 0 : this.measureRealDirection(), this.interactiveDrag ? (this._animation.timeline.progress() < 1 && this._animation.setTouchEnd(s, this.currentInteraction.progress, i.time), this._animation.setTouch(!1)) : s && this.callAction(this.currentInteraction.animationStartDirection), this.swipeElement.removeClass("n2-grabbing")), this.onEnd(), delete this.currentInteraction, Math.abs(i.x) < 10 && Math.abs(i.y) < 10 ? this.onTap(t) : nextend.preventClick()
    }, i.prototype.onEnd = function () {
        var t, e, i, s, n;
        "scroll" === this.currentInteraction.action && "pointer" === this.currentInteraction.type && (t = this.currentInteraction.distanceY[0], e = this.currentInteraction.distanceY[this.currentInteraction.distanceY.length - 1], i = (t.d - e.d) / (e.t - t.t) * 10, s = Date.now(), n = function () {
            requestAnimationFrame(function () {
                var t;
                if (!this.kineticScrollCancelled && i && (t = Date.now() - s, 1 < (t = i * Math.exp(-t / 325)) || t < -1)) return this.$window.scrollTop(this.$window.scrollTop() + t), void n();
                this.onEndKineticScroll()
            }.bind(this))
        }.bind(this), this.kineticScrollCancelled = !1, n(), document.addEventListener("pointerdown", this.cancelKineticScroll))
        ...
        var t;
        "unknown" === this.currentInteraction.action && 1 < this.slider.visibleSlides.length && ("ended" === this._animation.state ? "unknown" !== (t = this.currentInteraction.direction) && this.currentInteraction.state[t] && (this.currentInteraction.animationStartDirection = t, this.interactiveDrag && (this._animation.setTouch(this.axis), this.callAction(t, !1)), this.currentInteraction.action = "switch", this.swipeElement.addClass("n2-grabbing")) : "playing" === this._animation.state && (this.currentInteraction.action = "hold"))
        ...
        var i, s = !1;
        for (i in t) this.state[i] !== t[i] && (this.state[i] = t[i], s = !0);
        s && e && this.eventBurrito.supportsPointerEvents && this.syncTouchAction()
    }, i
    ...
    return ((i.prototype = Object.create(N2Classes.SmartSliderControlTouch.prototype)).constructor = i).prototype.callAction = function (t, e) {
        ...
        var t = this.slider.currentSlide.index,
            ...
            t = 0 <= t - 1;
        this.slider.parameters.carousel && (t = e = !0), n2const.isRTL() && "vertical" !== this.slider.getAnimationAxis() ? this.setState({
            right: e,
            left: t
        }, !0) : this.setState({
            right: t,
        ...
        this.swipeElement.css("touch-action", i.join(" ")), window.PointerEventsPolyfill && this.swipeElement.attr("touch-action", i.join(" "))
    }, i
    ...
    return i.Strong = ["lightbox"], i.prototype.add = function (t) {
        ...
        var t, e = {};
        for (t in this.waits) 1 === this.waits[t] && -1 !== i.Strong.indexOf(t) && (e[t] = 1);
        this.waits = e, this._refresh()
...
}), N2D("SmartSliderSlideBackgroundImage", function (n, i) {
    function t(t, e, i, s) {
        this.loadStarted = !1, this.loadAllowed = !1, this.slide = t, this.manager = e, this.background = i, this.deferred = n.Deferred(), this.$background = s, this.blur = s.data("blur"), "blurfit" === i.mode && (window.n2FilterProperty ? (this.$background = this.$background.add(this.$background.clone().insertAfter(this.$background)), this.$background.first().css({
            margin: "-14px",
            padding: "14px"
    ...
    return t.prototype.getLoadedDeferred = function () {
        ...
        this.$background.n2imagesLoaded({
            ...
            if (0 < t.images.length) {
                t = t.images[0].img;
                switch (this.width = t.naturalWidth, this.height = t.naturalHeight, this.background.mode) {
                    case "tile":
                    case "center":
        ...
        var e;
        this.loadAllowed && t !== this.currentSrc && ("" === t ? this.$background.css("background-image", "") : this.$background.css("background-image", 'url("' + t + '")'), this.currentSrc = t, this.$seo !== i && (this.$seo.remove(), delete this.$seo), (e = this.$background.data("alt")) && (e = {
            alt: e,
            src: t
        }, (t = this.$background.data("title")) && (e.title = t), this.$seo = n('<img style="display:none;">').attr(e).appendTo(this.$background)))
    }, t.prototype.fadeOut = function () {
        NextendTween.to(this.$background, .3, {
            opacity: 0
        })
    }, t
}), N2D("SmartSliderSlideBackground", function (o, t) {
    function e(t, e, i) {
        var s;
        this.loadStarted = !1, this.types = this.types || {
            color: "SmartSliderSlideBackgroundColor",
            image: "SmartSliderSlideBackgroundImage",
            video: "SmartSliderSlideBackgroundVideo"
        }, this.width = 0, this.height = 0, this.slide = t, this.element = e, t.slider.needBackgroundWrap ? (s = e.find("> *"), this.$wrapElement = o('<div class="n2-ss-slide-background-wrap n2-ow"></div>').appendTo(e).append(s)) : this.$wrapElement = this.element, this.manager = i, this.loadDeferred = o.Deferred(), this.elements = {
            color: !1,
            image: !1,
            video: !1
        }, this.currentSrc = "", this.mode = e.data("mode"), this.opacity = e.data("opacity");
        e = this.element.find(".n2-ss-slide-background-image");
        e.length && (this.elements.image = new N2Classes[this.types.image](t, i, this, e));
        e = this.element.find(".n2-ss-slide-background-color");
        e.length && (this.elements.color = new N2Classes[this.types.color](this, e));
        var n, r = [];
        for (n in this.elements) this.elements[n] && r.push(this.elements[n].getLoadedDeferred());
        o.when.apply(o, r).then(function () {
    ...
    function t(t, e, i, s) {
        this.wraps = {}, N2Classes.FrontendComponent.prototype.constructor.apply(this, arguments)
    }
    return ((t.prototype = Object.create(N2Classes.FrontendComponent.prototype)).constructor = t).prototype.init = function (t) {
        ...
        e = this.$layer.find("> .n2-ss-layer-parallax");
        switch (e.length && (this.wraps.parallax = e), this.$layer.data("pm")) {
            case "absolute":
        ...
        this.parallax = this.$layer.data("parallax"), this.baseSize = this.baseSize || 100, this.isAdaptiveFont = this.isAdaptiveFont || this.parent.isAdaptiveFont || this.get("adaptivefont"), this.refreshBaseSize(this.getDevice("fontsize", 100)), N2Classes.FrontendComponent.prototype.init.call(this, t)
    }, t.prototype.setState = function (t, e) {
        this.state[t] = e;
        ...
        e / 360 != 0 && (t = this.addWrap("rotation", "<div class='n2-ss-layer-rotation'></div>"), NextendTween.set(t[0], {
            rotationZ: e
        }))
        ...
        if (this.isVisible = this.getDevice("") && this.parent.isVisible, this.isVisible === n && (this.isVisible = 1), e && !this.isVisible ? (this.$layer.data("shows", 0), this.$layer.css("display", "none"), this.$layer.triggerHandler("visibilityChange", [0])) : !e && this.isVisible && (this.$layer.data("shows", 1), this.$layer.css("display", ""), this.$layer.triggerHandler("visibilityChange", [1])), this.isVisible) {
            e = this.getDevice("fontsize", 100);
            this.refreshBaseSize(e), !this.parent.isAdaptiveFont && this.isAdaptiveFont ? this.$layer.css("font-size", N2Classes.FontSize.toRem(16 * e / 100)) : this.$layer.css("font-size", e + "%");
            ...
            for (i = 0; i < this.children.length; i++) this.children[i].onDeviceChange(t)
    }, t.prototype.onAfterDeviceChange = function (t) {}, t.prototype.onResize = function (t, e) {
        var i;
        (this.isVisible || this.placement.alwaysResize) && (!this.parent.isAdaptiveFont && this.isAdaptiveFont && (i = this.getDevice("fontsize", 100), this.$layer.css("font-size", N2Classes.FontSize.toRem(16 * i / 100))), N2Classes.FrontendComponent.prototype.onResize.apply(this, arguments), this.placement.onResize(t, e))
    }, t.prototype.hasLayerAnimation = function () {
        return this.animationManager !== n
    }, t.prototype.addWrap = function (t, e) {
        var i;
        return this.wraps[t] === n && (i = s(e), "rotation" === t && (this.wraps.mask !== n ? i.appendTo(this.wraps.mask) : this.wraps.parallax !== n ? i.appendTo(this.wraps.parallax) : i.appendTo(this.$layer), i.append(this.getContents())), this.wraps[t] = i), i
    }, t.prototype.getContents = function () {
        return !1
    }, t
}), N2D("FrontendComponent", function (t, s) {
    function e(t, e, i, s) {
    ...
    }, e.prototype.getDevice = function (t, e) {
        var i = this.$layer.data(this.device + t);
        return i !== s ? i : "desktopportrait" !== this.device ? this.$layer.data("desktopportrait" + t) : e !== s ? e : 0
    }, e.prototype.get = function (t) {
        return this.$layer.data(t)
    }, e
}), N2D("FrontendSlideControls", function (t, e) {
    function i(t, e) {
        this.slider = t, this.$element = e.data("slide", this), this.status = new N2Classes.SlideStatus
    }
    return i.prototype.isCurrentlyEdited = function () {
    ...
    }, i.prototype.isVisibleWhen = function (t) {
        return !0
    }, i.prototype.isActiveWhen = function (t) {
        return !0
...
}), N2D("FrontendSliderSlide", ["FrontendSliderSlideAbstract"], function (n, r) {
    function t(t, e, i) {
        ...
        var s = "";
        this.$element.data("title") !== r && (s = this.$element.data("title")), this.$slideFocus = n('<div tabindex="-1" class="n2-ss-slide--focus" role="note">' + s + "</div>").prependTo(this.$element), this.$focusableElements = this.$element.find('a[href]:not([href=""]),link,button,input:not([type="hidden"]),select,textarea,audio[controls],video[controls],[tabindex]:not([tabindex="-1"])'), this.disableFocus(), this.background = !1, t.parameters.admin ? this.minimumSlideDuration = 0 : (this.minimumSlideDuration = e.data("slide-duration"), n.isNumeric(this.minimumSlideDuration) || (this.minimumSlideDuration = 0)), this._isCurrentlyEdited = this.slider.parameters.admin && this.$element.hasClass("n2-ss-currently-edited-slide"), this.isCurrentlyEdited() ? (this.$layer = e.find('.n2-ss-layer[data-sstype="slide"]'), t.sliderElement.on({
    ...
    return e.prototype.setIndex = function (t) {
        ...
        for (var t = this; t = t.previousSlide, t && t !== this && !t.isVisible;);
        return t
    }, e.prototype.setNext = function (t) {
        (this.nextSlide = t) && t.setPrevious(this)
    }, e.prototype.getNext = function () {
        for (var t = this; t = t.nextSlide, t && t !== this && !t.isVisible;);
        return t
    ...
    function i(t, e) {
        N2Classes.FrontendSlideControls.prototype.constructor.call(this, t, e), this.slides = [this], this.isVisible = !0, this._isCurrentlyEdited = this.slider.parameters.admin && this.$element.hasClass("n2-ss-currently-edited-slide"), this.isCurrentlyEdited() ? this.$layer = this.$element.find('.n2-ss-layer[data-sstype="slide"]') : (this.component = new N2Classes.FrontendComponentSectionSlide(this, t, e.find('.n2-ss-layer[data-sstype="slide"]')), this.$layer = this.component.$layer)
    }
    ...
    return ((i.prototype = Object.create(N2Classes.FrontendPlacement.prototype)).constructor = i).prototype.start = function () {
        ...
        var r = s,
            o = n;
        parseInt(this.layer.get("responsivesize")) || (r = o = 1), i.css("width", this.getWidth(r)), i.css("height", this.getHeight(o)), parseInt(this.layer.get("responsiveposition")) || (s = n = 1);
        var a = this.layer.getDevice("left") * s,
            l = this.layer.getDevice("top") * n,
            o = this.layer.getDevice("align"),
            s = this.layer.getDevice("valign"),
            h = {
                left: "auto",
                top: "auto",
                right: "auto",
        ...
        if (this.$parent && this.$parent.data("layer").isVisible) {
            var d = {
                    left: (n = this.$parent).prop("offsetLeft"),
                    top: n.prop("offsetTop")
                },
                c = {
                    left: 0,
                    top: 0
            ...
            switch (this.layer.getDevice("parentalign")) {
                case "right":
                    c.left = d.left + this.$parent.width();
                    break;
                case "center":
                    c.left = d.left + this.$parent.width() / 2;
                    break;
                default:
                    c.left = d.left
            }
            switch (o) {
                case "right":
                    h.right = i.parent()[0].offsetWidth - c.left - a + "px";
                    break;
                case "center":
                    h.left = c.left + a - i.width() / 2 + "px";
                    break;
                default:
                    h.left = c.left + a + "px"
            }
            switch (this.layer.getDevice("parentvalign")) {
                case "bottom":
                    c.top = d.top + this.$parent.height();
                    break;
                case "middle":
                    c.top = d.top + this.$parent.height() / 2;
                    break;
                default:
                    c.top = d.top
            }
            switch (s) {
                case "bottom":
                    h.bottom = i.parent()[0].offsetHeight - c.top - l + "px";
                    break;
                case "middle":
                    h.top = c.top + l - i.height() / 2 + "px";
                    break;
                default:
                    h.top = c.top + l + "px"
            }
            ...
            switch (o) {
                case "right":
                    ...
                    break;
                case "center":
                    var p = !this.layer.slide.isStatic && this.layer.parent instanceof N2Classes.FrontendComponentSectionSlide ? e.slideWidth : i.parent()[0].offsetWidth;
                    h.left = Math.round(p / 2 + a - i.width() / 2) + "px";
                    break;
                default:
                    h.left = a + "px"
            }
            switch (s) {
                case "bottom":
                    ...
                    break;
                case "middle":
                    var u = !this.layer.slide.isStatic && this.layer.parent instanceof N2Classes.FrontendComponentSectionSlide ? e.slideHeight : i.parent()[0].offsetHeight;
                    h.top = Math.round(u / 2 + l - i.height() / 2) + "px";
                    break;
                default:
                    h.top = l + "px"
            }
        ...
        i.css(h);
        for (var m = 0; m < this.linked.length; m++) this.linked[m].onResizeLinked(t, e)
    ...
    return ((i.prototype = Object.create(N2Classes.FrontendPlacement.prototype)).constructor = i).prototype.onDeviceChange = function () {
        ...
        var t, e = this.layer.getDevice("height"),
            i = "px";
        0 < e ? (0 < (t = this.layer.baseSize) && (i = "em", e = parseInt(e) / t), this.layer.$layer.css("height", e + i).attr("data-custom-height", 1)) : this.layer.$layer.css("height", "").removeAttr("data-custom-height")
    ...
    return ((t.prototype = Object.create(N2Classes.FrontendComponentCommon.prototype)).constructor = t).prototype.init = function (t) {
        ...
        var t = parseInt(this.getDevice("wrapafter")),
            ...
            s = !1;
        if (0 === i) return !1;
        if (0 < t && t < i && (s = !0), this.$row.attr("row-wrapped", s ? 1 : 0), s) {
            for (var n = [], r = 0; r < i; r++) {
                var o = Math.floor(r / t);
                n[o] === c && (n[o] = []), n[o].push(e[r]), e[r].$layer.attr("data-r", o).toggleClass("n2-ss-last-in-row", (r + 1) % t == 0 || r === i - 1)
            }
            var a = this.getDevice("gutter");
            for (r = 0; r < n.length; r++) {
                for (var l = n[r], h = 0, d = 0; d < l.length; d++) h += l[d].getWidthPercentage();
                for (d = 0; d < l.length; d++) l[d].$layer.css("width", "calc(" + l[d].getWidthPercentage() / h * 100 + "% - " + (n2const.isIE || n2const.isEdge ? a + 1 : a) + "px)")
            }
        } else {
            h = 0;
            for (r = 0; r < i; r++) h += e[r].getWidthPercentage();
            for (r = 0; r < i; r++) e[r].$layer.css("width", e[r].getWidthPercentage() / h * 100 + "%").removeClass("n2-ss-last-in-row").attr("data-r", 0);
...
}), N2D("SmartSliderResponsive", function (o, t) {
    function a(t, e) {
        this.state = {
            StarterSlide: !1
    ...
    return a.DeviceMode = {
    ...
    }, a.prototype.setDeviceID = function (t) {
        this.deviceID = t, this.device = a._DeviceMode[t]
        ...
        if (this.slider.stages.done("ResizeFirst", function () {
            ...
            }.bind(this)), this.normalizeTimeout = null, this.delayedResizeAdded = !1, this.setDeviceID(a.DeviceMode.unknown), this.ratios = {
                slideW: 1,
                slideH: 1
            ...
            if (o(window).on({
                ...
                o('<iframe class="bt_skip_resize intrinsic-ignore" title="Resize helper" sandbox="allow-same-origin allow-scripts" style="margin:0 !important;padding:0;border:0;display:block;width:100%;height:0;min-height:0 !important;max-height:0;"></iframe>').on("load", function (t) {
                    var i = 0,
                        s = o(t.target.contentWindow || t.target.contentDocument.defaultView).on("resize", function (t) {
                            var e = s.width();
    ...
    }, a.prototype.internalResize = function () {
        this.onResize()
    }, a.prototype.getMinimumContentHeight = function () {
        for (var t, e = this.slider.visibleRealSlides, i = 0, s = 0; s < this.slider.visibleRealSlides.length; s++) e[s].$layer.addClass("n2-ss-layer--height-calc");
        for (s = 0; s < this.slider.visibleRealSlides.length; s++) t = e[s].$layer.outerHeight(), i = Math.max(i, t), e[s].$layer.data("contentHeight", t);
        for (s = 0; s < this.slider.visibleRealSlides.length; s++) e[s].$layer.removeClass("n2-ss-layer--height-calc");
        return i
    }, a.prototype.getMinimumStaticContentHeight = function () {
        for (var i = 0, t = o(), e = 0; e < this.slider.staticSlides.length; e++) t = t.add(this.slider.staticSlides[e].$element[0]);
        return t.addClass("n2-ss-layer--height-calc").each(function (t, e) {
            i = Math.max(i, o(e).outerHeight())
        }).removeClass("n2-ss-layer--height-calc"), i
    }, a.prototype.getDeviceMode = function () {
        return a._DeviceMode[this.deviceID]
    }, a.prototype.getDeviceGroup = function () {
        return a._DeviceGroup[this.getDeviceMode()]
    }, a.prototype.onResize = function (t) {
    ...
    }, a.prototype.doNormalizedResize = function () {
        this.normalizeTimeout && clearTimeout(this.normalizeTimeout), this.normalizeTimeout = setTimeout(this.doResize.bind(this), 10)
    }, a.prototype.identifyDeviceID = function () {
        this.containerElementPadding.css("overflow", "hidden");
        var t, e, i = a.DeviceMode.desktopPortrait,
            s = window.n2Width || window.innerWidth,
            n = window.n2Height || window.innerHeight;
        this.isLandscape = n < s;
        for (var r = this.parameters.breakpoints.length - 1; 0 <= r; r--)
            if (t = this.parameters.breakpoints[r], e = this.isLandscape ? t.landscapeWidth : t.portraitWidth, "max-screen-width" === t.type) {
                if (s <= e) {
                    i = a.DeviceMode[t.device];
                    break
                }
    ...
    }, a.prototype.updateOffsets = function () {
        if (this.focusOffsetTop = 0, "" !== this.parameters.focus.offsetTop)
            for (var t = o(this.parameters.focus.offsetTop), e = 0; e < t.length; e++) t.eq(e).is(":visible") && (this.focusOffsetTop += t.eq(e).outerHeight());
        if (this.slider.isAdmin && (this.focusOffsetTop += o(".n2-lb-header").outerHeight()), this.focusOffsetBottom = 0, "" !== this.parameters.focus.offsetBottom) {
            var i = o(this.parameters.focus.offsetBottom);
            for (e = 0; e < i.length; e++) i.eq(e).is(":visible") && (this.focusOffsetBottom += i.eq(e).outerHeight())
        }
    }, a.prototype.calculateFullPageSliderHeight = function (t) {}, a.prototype.doResize = function (t) {
        var e, i, s = this.identifyDeviceID();
        if (this.parameters.hideOn[a._DeviceMode[s]]) return this.$section.addClass("n2-section-smartslider--hidden"), !1;
        if (this.$section.removeClass("n2-section-smartslider--hidden"), !this.containerElementPadding.is(":visible")) return !1;
        this.updateOffsets(), this.disableTransitions || (this.disableTransitions = !0, this.sliderElement.addClass("n2notransition"), this.disableTransitionsTimeout && clearTimeout(this.disableTransitionsTimeout), this.disableTransitionsTimeout = setTimeout(function () {
            this.sliderElement.removeClass("n2notransition"), this.disableTransitions = !1
        }.bind(this), 500)), this.slider.isAdmin || this.parameters.forceFull && ("none" !== this.parameters.forceFullOverflowX && o(this.parameters.forceFullOverflowX).css("overflow-x", "hidden"), n = i = 0, this.parameters.forceFullHorizontalSelector = window.ssForceFullHorizontalSelector || this.parameters.forceFullHorizontalSelector, "" === this.parameters.forceFullHorizontalSelector || (r = this.sliderElement.closest(this.parameters.forceFullHorizontalSelector)) && 0 < r.length && (i = (e = r[0].getBoundingClientRect()).width, n = n2const.rtl.isRtl ? (document.body.clientWidth || document.documentElement.clientWidth) - e.right : e.left), r = 0 < i ? i : document.body.clientWidth || document.documentElement.clientWidth, i = (e = this.containerElement.parent())[0].getBoundingClientRect(), n = -(n2const.rtl.isRtl ? (document.body.clientWidth || document.documentElement.clientWidth) - i.right : i.left) - parseInt(e.css("paddingLeft")) - parseInt(e.css("borderLeftWidth")) + n, this.containerElement.css({
            marginLeft: n,
            marginRight: n
        }).width(r));
        var n = !1,
            r = this.device;
        this.deviceID !== s && (this.setDeviceID(s), this.sliderElement.removeClass("n2-ss-" + r).attr("data-device-mode", this.device).addClass("n2-ss-" + this.device), this.sliderElement.trigger("SliderDevice", {
            lastDevice: r,
            device: this.device,
            group: a._DeviceGroup[this.device]
        }), n = !0, this.slider.stages.resolve("Device")), n && (this.slider.visibleRealSlides = [], this.sliderElement.trigger("SliderDeviceOrientation", {
            slider: this.slider,
            lastDevice: r,
            device: this.device,
            group: a._DeviceGroup[this.device]
    ...
    }, a.prototype.resizeStage1Width = function () {
        this.resizeContext = {}
    }, a.prototype.resizeStage2Height = function () {
    ...
    }, a.prototype.resizeStage2HeightAnimated = function (t, e, i) {
    ...
    }, a.prototype.getResizeStage2CSS = function () {}, a.prototype.onStarterSlide = function (t) {
        this.state.StarterSlide = !0, this.calibrateActiveSlide(t), delete this.targetCurrentSlide
    }, a.prototype.finalizeVisibleSlidesStage1 = function () {
    ...
    }, a.prototype.updateVisibleSlides = function () {
        this.slider.visibleSlides = this.slider.visibleRealSlides
    }, a.prototype.calibrateActiveSlide = function (t) {
        this.state.StarterSlide && 0 < this.slider.visibleSlides.length && ((t = t || this.slider.currentRealSlide).isVisible || (t = (t = t.getNext()) || this.slider.currentSlide.getPrevious()), this.resetActiveRealSlide(t))
    }, a.prototype.resetActiveRealSlide = function (t) {
        var e, i;
    ...
    }, a.prototype.finalizeVisibleSlidesStage2 = function () {
    ...
    }, a.prototype.triggerVisibleSlidesChanged = function () {
    ...
    }, a.prototype.getNormalizedModeString = function () {
        return a._DeviceMode[this.deviceID]
    }, a.prototype.triggerResize = function () {
        this.slider.publicTrigger("SliderResize", [this.ratios, this]), this.slider.stages.resolve("Resized")
    }, a.prototype.getVerticalOffsetHeight = function () {
    ...
    }, a.prototype.addHorizontalSpacingControl = function (t, e) {
        this.horizontalSpacingControls[t].push(e), this.slider.stages.resolved("ResizeFirst") && this.doNormalizedResize()
    }, a.prototype.filterSliderWidthHorizontalSpacing = function (t) {
    ...
    }, a.prototype.addFilter = function (t, e) {
        this.filters[t].push(e)
    }, a.prototype.removeFilter = function (t, e) {
        this.filters[t].push(e)
    }, a.prototype.applyFilter = function (t, e) {
        for (var i = 0; i < this.filters[t].length; i++) e = this.filters[t][i].call(this, e);
        return e
    }, a.prototype.prepareFontSize = function (t) {
        return N2Classes.FontSize.toRem(t)
    }, a
}), N2D("FrontendItemVimeo", function (o, e) {
    function i(t, e, i, s, n, r) {
        if (this.state = {
                ...
                play: !1,
                continuePlay: !1
            }, this.readyDeferred = o.Deferred(), this.slider = t, this.playerId = e, this.$playerElement = o("#" + this.playerId), this.$cover = this.$playerElement.find(".n2_ss_video_player__cover"), this.start = r, this.parameters = o.extend({
    ...
    return i.vimeoDeferred = null, i.prototype.ready = function (t) {
        ...
        this.layer = e.data("layer"), this.layer.isVisible && this.setState("visible", !0, !0), this.layer.$layer.on("visibilityChange", function (t, e) {
            e ? this.setState("visible", !0, !0) : (e = this.state.play, this.setState("visible", !1, !0), e && this.setState("continuePlay", !0))
        ...
        this.setState("InComplete", !0, !0), this.isStatic ? (this.setState("play", !0), this.setState("slide", !0, !0)) : (this.slider.sliderElement.on("mainAnimationComplete", function (t, e, i, s, n) {
...
}), N2D("FrontendItemYouTube", function (r, o) {
    function a(t, e, i, s) {
        this.state = {
            slideVisible: !1,
            visible: !1,
            ...
            play: !1,
            continuePlay: !1
        }, this.readyDeferred = r.Deferred(), this.slider = t, this.playerId = e, this.$playerElement = r("#" + this.playerId), this.$cover = this.$playerElement.find(".n2_ss_video_player__cover"), this.parameters = r.extend({
    ...
    return a.YTDeferred = null, a.prototype.ready = function (t) {
        var e, i, s, n;
        null === a.YTDeferred && (a.YTDeferred = r.Deferred(), window.YT === o && r.getScript("https://www.youtube.com/iframe_api"), window._EPYT_ !== o ? (s = a.YTDeferred, (n = function () {
            !0 === window._EPADashboard_.initStarted ? s.resolve() : setTimeout(n, 100)
        })()) : (e = a.YTDeferred, (i = function () {
            window.YT !== o && window.YT.loaded ? e.resolve() : setTimeout(i, 100)
        })())), a.YTDeferred.done(t)
    }, a.prototype.fadeOutCover = function () {
        this.coverFadedOut === o && this.$cover.length && (this.coverFadedOut = !0, NextendTween.to(this.$cover, .3, {
            opacity: 0,
            onComplete: function () {
                this.$cover.remove()
            }.bind(this)
        ...
        for (t in n2const.isIOS && this.parameters.controls && (i.use_native_controls = 1), 1 == this.parameters.center && (i.controls = 0), 1 != this.parameters.controls && (i.autohide = 1, i.controls = 0), +(0 <= navigator.platform.toUpperCase().indexOf("MAC") && -1 < navigator.userAgent.search("Firefox")) && (i.html5 = 1), this.parameters.query) this.parameters.query.hasOwnProperty(t) && (i[t] = this.parameters.query[t]);
        var s = {
        ...
        t = this.slide.isActiveWhen(t);
        t && 1 == this.parameters.autoplay && this.setState("play", !0), this.setState("slide", t, !0)
        ...
        t[n2const.rtl.marginLeft] = 0, 16 / 9 < e / i ? (t.height = e * (16 / 9), t.marginTop = (i - t.height) / 2) : (t.width = i * (16 / 9), t[n2const.rtl.marginLeft] = (e - t.width) / 2), this.$playerElement.css(t)
    }, a.prototype.initAutoplay = function () {
        this.setState("InComplete", !0, !0), this.isStatic ? (this.setState("play", !0), this.setState("slide", !0, !0)) : (this.slider.sliderElement.on("mainAnimationComplete", function (t, e, i, s) {
            this.slide.isActiveWhen(this.slider.slides[s]) ? (this.setState("play", !0), this.setState("slide", !0, !0)) : this.setState("slide", !1, !0)
        }.bind(this)), this.slide.isActiveWhen() && (this.setState("play", !0), this.setState("slide", !0, !0)))
        ...
        this.isStopped() && (this.coverFadedOut === o && setTimeout(this.fadeOutCover.bind(this), 200), this.slider.trigger("mediaStarted", this.playerId), this.player.playVideo())
